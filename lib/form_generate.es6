...
function prepareFormData(details, options) {
  ...
  return {
    ...
    renewalDate: addYearsString(details.regDate, options.addYears.renewalDate),
    markType: details.markType.join(', '),
    register: details.register.join(', '),
    filingDate: addYearsString(details.filingDate, options.addYears.filingDate),
    dateInLocation: addYearsString(details.dateInLocation, options.addYears.dateInLocation),
    regDate: addYearsString(details.regDate, options.addYears.regDate),
